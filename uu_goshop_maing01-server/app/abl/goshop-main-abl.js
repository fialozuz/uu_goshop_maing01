...
const Errors = require("../api/errors/goshop-main-error.js");
...
const logger = LoggerFactory.get("GoshopMainAbl");
...
module.exports = new GoshopMainAbl();
